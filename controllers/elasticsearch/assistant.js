...
const assistant = require('../../services/elasticsearch/assistant')
...
const chats = async (req, res) => {
  try {
    const result = await assistant.askQna(req.body.userQuestion)
...
router.post('/assistant', validation, chats)
