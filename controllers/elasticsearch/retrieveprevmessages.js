...
const { getMessagesFromTopics } = require('../../services/elasticsearch/retrieveprevmessages')
...
const getMessages = async (req, res) => {
  try {
    const result = await getMessagesFromTopics(req.body)
...
router.post('/getMessagesByTopic', validation, getMessages)
