...
const { getworkflowruns } = require('../../services/github/getworflowruns')
...
const getworkflowrun = async (req, res) => {
  try {
    const result = await getworkflowruns(req.headers.authorization, req.body)
    console.log(result)
...
router.post('/getworkflowruns', validation, getworkflowrun)
