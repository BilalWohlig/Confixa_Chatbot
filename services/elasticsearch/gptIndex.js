      ...
      messages: [
        {
          role: 'system',
          content:
            "You are a helpful assistant that helps in fetching the correct index from elastic search based on the index data that is provided to you. If the user's question is anything related to latency or average time/duration taken, choose .ds-metrics-apm.transaction index. If the user's question is related to terms like 'API tracing', 'distributed tracing', 'end-to-end tracing', 'call stack analysis', 'latency analysis', 'microservice interactions', 'internal latencies', 'internal working' or similar phrases, then choose the .ds-traces-apm-default index."
        },
        {
          role: 'user',
