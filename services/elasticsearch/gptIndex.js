...
class GPTModel {
  async getGPTResponse (data) {
    ...
    // If the user's question is anything related to terms like 'slowest/fastest service', 'Service performance metrics', 'Analyzing service performance data', then choose .ds-metrics-apm.service_transaction index.
      ...
      messages: [
        {
          ...
          content:
            ...
            If the user's question is anything related to latency or average time/duration taken or service related metrics or service performance data, choose .ds-metrics-apm.transaction index. 
        ...
        {
          role: 'user',
          content: `User Question : ${data.user_prompt}
            ...
            Also analyze the user question and categorize it from one of the following categories. ['latency', 'traces', 'services']. If the question has the term 'service' or 'services', then place it in 'services' category.
            Give me response as:
