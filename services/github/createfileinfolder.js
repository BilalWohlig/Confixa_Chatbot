...
class CreateFilesInFolder {
  async createfilesinfolder (githubtoken, data) {
    const method = 'PUT'
    const endpointurl = '/repos/' + data.username + '/' + data.reponame + '/contents/.github/workflows/' + data.filename + '.yaml'
    var jsonPath = path.join(__dirname, '../../static/github_actions.yaml')
...
module.exports = new CreateFilesInFolder()
